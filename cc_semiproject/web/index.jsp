 ...
 %>
	...
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a href="index.jsp"><img src="images/C&C Logo.jpg" alt="Logo" width="120" height="50"></a>
			<!-- class="navbar-brand" -->
		</div>
				...
				<div id="div-forms">
					...
					<form id="login-form">
						<div class="modal-body">
							...
							<input id="login_username" class="form-control" type="email"
						...
						<div class="modal-footer">
							<div>
								<button type="submit" class="btn btn-primary btn-lg btn-block" id="loginSuccess">로그인</button>
							</div>
							<div>
					...
					<form id="register-form" style="display: none;">
						<div class="modal-body">
							...
							<input id="register_email_confirm" class="form-control" type="text"
							...
							<input id="register_phone" class="form-control" type="text"
