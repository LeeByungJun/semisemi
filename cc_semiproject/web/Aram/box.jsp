...
<body>
<input type="hidden" value="<%= userID.getEmail() %>" id="userid">
	...
	<nav class="navbar navbar-default">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index.jsp">채팅 서비스</a>
		</div>
		<div class="collapse navbar-collapse"
			id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				<li><a href="/cs/Aram/chat.jsp?toID=<%= toID %>">채팅하기</a></li>
		                <li class="active"><a href="box.jsp">메세지함<span id="unread" class="Label Label-info"></span></a></li> 
				<li class="active"><a href="/cs/p2plist?page=1">돌아가기</a>
			</ul>
