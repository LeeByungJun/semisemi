...
/**
 * Servlet implementation class ShortReservationServlet
 */
@WebServlet("/s_reservation")
public class ShortReservationServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShortReservationServlet() {
        super();
